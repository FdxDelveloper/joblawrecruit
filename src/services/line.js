...
const initChat = id => {
  bot.sendTemplate({
    ...
    actions: [{
      type: "postback",
      label: "สมัครงานตำเเหน่ง 💳",
      data: "nomoney"
    }, {
      type: "postback",
      label: "ที่ตั้งของที่ทำงาน ⚖️",
      data: "lawsuit"
    }, {
      type: "postback",
      label: "เงินเดือน 🚗",
...
const REPLY = {
  "nomoney": [`คุณต้องการที่จะสมัครในตำเเหน่งใหนละ  บอกผมมาสิเผื่อผมจะช่วยคุณได้ ใจเย็นๆๆค่อยๆพิมพ์ 👊`],

  "policetookmycar": [
    `เงินเดือนตามขั้นของประสบการณ์ทำงาน  😶`,
    `เราไม่สนใจหรอกนะว่านายจะจบมาจากใหน ถ้านายเจ๋งจริงเราจ่ายคุณได้ 😉`
  ],

  "paparazzis": `สวัสดิการบอกเลยว่าจัดหนักจัดเต็ม ไม่ได้โม้นะบอกเลย 😊`,

  "P1": `งานที่ดีไม่จำเป็นต้องเงินเดือนเยอะ ถ้าคุณอยู่กับมันเเละชอบมันปัญหาที่คุณกำลังคิดอยู่มันจะไม่ยากอีกต่อไป`,
